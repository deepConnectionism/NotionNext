...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'NextAI', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '目标、计划和坚持', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://www.nextai.fun', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Notion, 博客, 人工智能, 深度学习, 机器人', // 网站关键词 英文逗号隔开
